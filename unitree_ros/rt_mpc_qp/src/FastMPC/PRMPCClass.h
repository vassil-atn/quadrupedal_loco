...
const int _footstepsnumber = 27;       //  number of _footstepnumber: for demo generation// walking on the flat ground
//const int _footstepsnumber = 15; // ball hit
const double _dt = gait::dt_mpc_slow;  //sampling time
const double _dt_mpc = gait::dt_mpc_fast;  //sampling time
const int _nh = 4;                     /// length of the prediction window  	
const double _tstep = gait::t_period;   ///time duratio ot the previous MPC
const int _nsum = _nh;                   
